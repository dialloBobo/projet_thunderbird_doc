...
const qe = function(e) {
...
}, I = document, F = "http://www.w3.org/2000/svg", Ee = function(e, t, n) {
  const o = I.createElementNS(F, "path");
  return x(o, {
    d: e,
    stroke: t || "#666",
    fill: "none",
  ...
  const t = I.createElementNS(F, "svg");
  return t.setAttribute("class", e), t.setAttribute("overflow", "visible"), t;
}, he = function() {
  const e = I.createElementNS(F, "line");
  ...
  const o = {
    ...
    "stroke-linecap": "cap",
    "stroke-width": "2"
  }, s = I.createElementNS(F, "g");
  return [e, t, n].forEach((i, r) => {
    const l = I.createElementNS(F, "path"), c = {
      d: i,
      ...o
    };
  ...
  for (const i of t)
    if (i)
      for (const r of n)
        i[e](r, o, { capture: !1, ...s });
  return [t, n, o, s];
}, P = Le("addEventListener"), N = Le("removeEventListener"), Y = (e) => {
  var t;
...
const Mt = function(e, t, n, o) {
  ...
  const y = Ie(`M ${l} ${c} C ${d} ${h} ${u} ${a} ${f} ${p}`, m, v), _ = l / 8 + d * 3 / 8 + u * 3 / 8 + f / 8, E = c / 8 + h * 3 / 8 + a * 3 / 8 + p / 8, w = Mt(o.label, _, E, e.theme.cssVar["--color"]);
...
const Bt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  const { parent: t, start: n, end: o } = Pt(e), s = { id: oe(), parent: t, start: n, end: o, text: "summary" }, i = Ne(this, s);
